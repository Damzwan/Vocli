<template>
  <div
      class="w-full bg-card-background hover:bg-card-background-hover active:bg-card-background-active border-card-border hover:border-b-card-border-hover rounded-xl py-3 grid grid-cols-[1fr_1fr_auto] gap-4 items-center relative"
  >
    <!-- From word with TTS -->
